...
public class PageResponseMoonDTO<E> {
    ...
    private long totalCount;                 // 전체 content 개수, 방문객 수
    ...
    public PageResponseMoonDTO(List<E> list, PageRequestDTO pageRequestDTO, long totalCount, long visitCount) {
        this.list = list;
