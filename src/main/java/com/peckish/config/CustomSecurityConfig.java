...
public class CustomSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOriginPatterns(Arrays.asList("https://hungrymoment.store", "http://localhost:5173", "*")); // 리소스 공유를 허용할 origin 설정 (*: 모든 출처에서의 요청 허용). "http://localhost:5173"
