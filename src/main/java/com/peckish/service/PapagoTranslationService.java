...
public class PapagoTranslationService {
    ...
    private static final String CLIENT_ID = "4wfrkqolon"; // 네이버 클라이언트 ID
    private static final String CLIENT_SECRET = "J2ZFvmjujYz3MEsEW4yPrWFH3sFsVWGb2pmQFBNH"; // 네이버 클라이언트 시크릿
